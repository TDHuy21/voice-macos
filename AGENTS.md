...
This project is indexed by GitNexus as **voice-macos** (592 symbols, 1125 relationships, 34 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
